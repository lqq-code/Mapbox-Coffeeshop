...
export default props => {
  ...
  const userConfig = {
    ...{'name':'xboilerplate','theme':'PRO','locale':true,'showBreadcrumb':true,'siderWidth':208,'navTheme':'light','primaryColor':'#2952EC','layout':'mix','contentWidth':'Fluid','fixedHeader':false,'fixSiderbar':true,'colorWeak':false,'title':'Map','pwa':false,'iconfontUrl':''},
    ...runtimeConfig || {}
  };
