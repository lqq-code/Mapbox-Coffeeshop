...
var FieldDigit = function FieldDigit(_ref, ref) {
  ...
  var proxyChange = useCallback(function (value) {
    var _Number, _fieldProps$precision;

    var val = (_Number = Number(value)) === null || _Number === void 0 ? void 0 : _Number.toFixed((_fieldProps$precision = fieldProps.precision) !== null && _fieldProps$precision !== void 0 ? _fieldProps$precision : 0);
